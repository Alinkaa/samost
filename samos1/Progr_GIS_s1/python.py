...
#3.    create a new feature class similar to facilities.shp in Results directory
...
#create new fields in the empty outFc
...
#4.	facilities_Distance_3000.shp COLLEGE_NAME
